...
<meta name="author" content="Sekou SONOMOU" />
          ...
          <div class="col-lg-5 col-md-8 py-8 py-xl-0">
            ...
            <div class="card shadow">
              ...
              <div class="card-body p-6 d-flex flex-column gap-4">
                <div>
                  {{-- <a href="https://geeksui.codescandy.com/geeks/index.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/brand/logo/logo-icon.svg" class="mb-4" alt="logo-icon" /></a> --}}
                ...
                {{-- <form class="needs-validation" novalidate> --}}
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email"  class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="Email address here" required />
