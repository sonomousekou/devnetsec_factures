...
<!-- Favicon icon-->
<link rel="shortcut icon" type="image/x-icon" href="https://geeksui.codescandy.com/geeks/assets/images/favicon/favicon.ico" />
...
<link rel="stylesheet" href="{{ asset('assets/css/theme.min.css') }}">
  ...
  <div class="container-fluid px-0">
    <a class="navbar-brand" href="https://geeksui.codescandy.com/geeks/index.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/brand/logo/logo.svg" alt="Geeks" /></a>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarPages">
            ...
            <li class="dropdown-submenu dropend">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="https://geeksui.codescandy.com/geeks/mentor/mentor.html">Home</a>
                </li>
                <li>
                  <a class="dropdown-item" href="https://geeksui.codescandy.com/geeks/mentor/mentor-list.html">List</a>
                </li>
                <li>
                  <a class="dropdown-item" href="https://geeksui.codescandy.com/geeks/mentor/mentor-single.html">Single</a>
                </li>
              </ul>
            </li>
            <li class="dropdown-submenu dropend">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDropdown">
            <div class="list-group">
              <a class="list-group-item list-group-item-action border-0" href="https://geeksui.codescandy.com/geeks/docs/index.html">
              ...
              <a class="list-group-item list-group-item-action border-0" href="https://geeksui.codescandy.com/geeks/docs/bootstrap-5-snippets.html">
                <div class="d-flex align-items-center">
              ...
              <a class="list-group-item list-group-item-action border-0" href="https://geeksui.codescandy.com/geeks/docs/changelog.html">
                <div class="d-flex align-items-center">
                ...
                <div class="card-body">
                  <div class="d-lg-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center mb-4 mb-lg-0">
                      <img src="{{ asset('assets/images/avatar/avatar-3.jpg') }}" id="img-uploaded" class="avatar-xl rounded-circle" alt="avatar" />
                      <div class="ms-3">
