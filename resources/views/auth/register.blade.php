          ...
          <div class="col-lg-5 col-md-8 py-8 py-xl-0">
            ...
            <div class="card shadow">
              ...
              <div class="card-body p-6 d-flex flex-column gap-4">
                <div>
                  <a href="https://geeksui.codescandy.com/geeks/index.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/brand/logo/logo-icon.svg" class="mb-4" alt="logo" /></a>
                  <div class="d-flex flex-column gap-1">
                    <h1 class="mb-0 fw-bold">Sign up</h1>
                    <span>
                      Already have an account?
                      <a href="{{ route('login.show') }}" class="ms-1">Sign in</a>
                    </span>
                  </div>
                </div>
                <!-- Form -->
